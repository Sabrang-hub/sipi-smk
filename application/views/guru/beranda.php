            ...
            <div class="col-lg-4 col-12">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <p class="text-muted font-14"><?= $data['nip'] ?></p>

                        <div class="text-start mt-3">
                            <h4 class="font-13 text-uppercase">Tentang :</h4>
                            <div class="row text-muted mb-2">
                                <div class="col-12 col-lg-4 font-13 fw-bold">Golongan</div>
                                <div class="col-12 col-lg-8 font-13"><span class="d-none d-lg-inline me-1">:</span><?= $data['nama_golongan'] ?></div>
                            </div>
                        </div>
...
<div class="modal fade" id="modal-foto" tabindex="-1" role="dialog" aria-labelledby="modal-foto-label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="fm-foto" action="<?= base_url('simpan-foto-guru') ?>" method="POST">
                <input type="hidden" id="guru_id" name="guru_id" value="<?= $this->session->userdata('kode') ?>" />
