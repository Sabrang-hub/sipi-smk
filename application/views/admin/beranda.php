                ...
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <?php if ($this->session->userdata('email') != '') : ?>
                            <p class="text-muted font-14"><?= $this->session->userdata('email') ?></p>
                        <?php endif ?>

                        <div class="text-start mt-3">
                            <h4 class="font-13 text-uppercase">Tentang :</h4>
                            <div class="row text-muted mb-2">
                                <div class="col-12 col-lg-4 font-13 fw-bold">Last Login</div>
                                <div class="col-12 col-lg-8 font-13"><span class="d-none d-lg-inline me-1">:</span><?= $this->session->userdata('last_login') ?></div>
                            </div>
                            <div class="row text-muted mb-2">
                                <div class="col-12 col-lg-4 font-13 fw-bold">Last Logout</div>
                                <div class="col-12 col-lg-8 font-13"><span class="d-none d-lg-inline me-1">:</span><?= $this->session->userdata('last_logout') ?></div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                <div class="card widget-flat bg-info text-white">
                    <div class="card-body">
                        <h5 class="text-white fw-normal mt-0" title="Pengguna">Pengguna</h5>
                        <h3 class="mt-3 mb-3"><?= $jumlah_pengguna ?></h3>
                    </div>
                </div>
            </div> <!-- end col-->
            ...
            <div class="col-lg-3 col-6">
                <div class="card widget-flat bg-danger text-white">
                    <div class="card-body">
                        <h5 class="text-white fw-normal mt-0" title="Jurusan">Jurusan</h5>
                        <h3 class="mt-3 mb-3"><?= $jumlah_jurusan ?></h3>
                    </div>
                </div>
            </div> <!-- end col-->
            ...
            <div class="col-lg-3 col-6">
                <div class="card widget-flat bg-success text-white">
                    <div class="card-body">
                        <h6 class="text-uppercase mt-0" title="Kelas">Kelas</h6>
                        <h3 class="mt-3 mb-3"><?= $jumlah_kelas ?></h3>
                    </div>
                </div>
            </div> <!-- end col-->
            ...
            <div class="col-lg-3 col-6">
                <div class="card widget-flat bg-primary text-white">
                    <div class="card-body">
                        <h5 class="fw-normal mt-0" title="Guru">Guru</h5>
                        <h3 class="mt-3 mb-3 text-white"><?= $jumlah_guru ?></h3>
                    </div>
                </div>
            </div> <!-- end col-->
        </div>
...
<div class="modal fade" id="modal-foto" tabindex="-1" role="dialog" aria-labelledby="modal-foto-label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="fm-foto" action="<?= base_url('simpan-foto') ?>" method="POST">
