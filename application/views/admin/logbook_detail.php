                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url('monitoring-siswa') ?>">Monitoring Siswa</a></li>
                        ...
                        <table id="list" class="table bg-success bg-opacity-10 table-bordered" style="width: 1283px;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:400px">Ket. Guru</th>
                                    <th style="width:400px">Ket. Pemb. Lapangan</th>
