            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <button title="Tambah" class="btn btn-primary btn-sm float-end" data-bs-toggle="modal" data-bs-target="#modal-form-kelompok"><i class="mdi mdi-account-plus"></i> <span class="d-none d-lg-inline">Tambah</span></button>
                        <h5>Daftar <?= @$title ?></h5>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="my-3">
                                ...
                                <select id="industri_id" name="industri_id" class="form-control" required></select>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12">
                            <div class="my-3">
                                <label for="guru_id" class="form-label">Guru Pembimbing<span class="text-danger">*</span></label>
                                <select id="guru_id" name="guru_id" class="form-control" required></select>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-5 col-12">
                            <div class="mb-3">
                                ...
                                <select id="siswa_id" name="siswa_id" class="form-control" required></select>
                            </div>
                        </div>
                        <div class="col-lg-3">
                        ...
                        <div class="col-auto pt-4 d-lg-block d-none">S/D</div>
                        <div class="col-lg-3">
