            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <span class="account-user-avatar">
                        <img src="<?= base_url($this->session->userdata('file_foto')) ?>" alt="user-image" width="32" class="rounded-circle file_foto" onerror="this.onerror=null;this.src='<?= base_url() ?>assets/images/users/avatar-11.png';">
                    </span>
                    <span class="d-lg-flex flex-column gap-1 d-none">
                        <h5 class="my-0"><?= $this->session->userdata('nama') ?></h5>
                        <h6 class="my-0 fw-normal"><?= $this->session->userdata('nama_group') ?></h6>
                    </span>
                </a>
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                    ...
                    <!-- item-->
                    <a href="<?= base_url('profil') ?>" class="dropdown-item d-none">
