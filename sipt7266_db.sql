...
CREATE TABLE `m_user` (
  ...
  `foto` varchar(255) NOT NULL DEFAULT 'assets/images/users/avatar-11.png',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `created_by` varchar(100) NOT NULL DEFAULT '',
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by` varchar(100) NOT NULL DEFAULT '',
...
insert  into `m_user`(`id`,`username`,`password`,`group_id`,`kode`,`nama`,`email`,`nama_industri`,`keterangan`,`last_login`,`last_logout`,`status_user_id`,`user_id`,`foto`,`created_at`,`created_by`,`updated_at`,`updated_by`) values 
(1,'admin','/ZthFL9VBx2NQYcnpiVAPa/Z/9zdeURJzWaRZRpwg/+IBGjD02K2G7BQpKDYr1R3QieOHBsI/cRBZciojXC4hQ==',1,'','Administrator','sabrang@gmail.com','','Administrator','2023-02-12 22:40:08','2023-02-12 22:40:51',1,0,'assets/images/users/avatar-11.png','2023-01-07 21:34:10','','2023-01-08 21:07:36','Administrator'),
(7,'1429041001','H45ZY43s1F88rcLnClw/Z/d3cSlN/gUPyBBDWAmKVeKgIM1daXNK0GLqshvENvlPNNmfWQs5XV2Itg1KR7knUw==',3,'1429041001','Sabrang','','','','2023-02-15 20:39:02','2023-02-15 20:38:24',1,1,'assets/images/users/avatar-11.png','2023-01-17 23:17:08','','2023-01-28 18:46:32','Administrator'),
(8,'195801081987032001','VFgcnrT8mPoVdgSmifkH2aiokb1MhyFZOH5bONBRCw4tG/XgRkSo9L69z5XtzLOTIDUV5/+VscsZTetWp4Kb/w==',2,'195801081987032001','Dr. Ir. Mustari S. Lamada, M.T.','','','','2023-02-12 19:19:58','2023-02-12 19:20:35',1,1,'assets/images/users/avatar-11.png','2023-01-17 23:24:33','Administrator',NULL,''),
(9,'rido','k9rzsvs0/VCCQWbpblz9LdotGtSgezscx4aq3KjwDYLdjkpfYMPYhWTOCZdXmSVKzU55n3YDpCgXWRVqAoKDOQ==',4,'9','Rido','rido@gmail.com','PT. Murfa Surya Mahardika','User Industri','2023-02-12 17:29:53','2023-02-12 17:31:46',1,8,'assets/images/users/avatar-11.png','2023-01-18 00:33:01','Dr. Ir. Mustari S. Lamada, M.T.',NULL,'');
...
insert  into `tbl_absen`(`id`,`siswa_id`,`nama_siswa`,`tanggal`,`waktu_masuk`,`waktu_pulang`,`status`,`keterangan_siswa`,`verifikasi_stat`,`verifikasi_at`,`verifikasi_by`,`verifikasi_ket`,`created_at`,`created_by`,`updated_at`,`updated_by`) values 
(8,'1429041001','Sabrang','2023-02-13','01:05:05.000000','01:05:05.000000',3,'',NULL,NULL,'',NULL,'2023-02-13 01:05:13.000000','Sabrang',NULL,''),
(9,'1429041001','Sabrang','2023-02-16','00:01:05.000000',NULL,1,'',NULL,NULL,'',NULL,'2023-02-16 00:01:16.000000','Sabrang',NULL,'');
...
(4,1,'PT. Murfa Surya Mahardika','195801081987032001','Dr. Ir. Mustari S. Lamada, M.T.','1429041001','Sabrang','2023-02-01','2023-02-28',9,'Rido','2023-01-17 22:49:17','Administrator','2023-02-12 19:20:12','Dr. Ir. Mustari S. Lamada, M.T.');
